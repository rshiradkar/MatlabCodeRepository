function writeVTK(matrix, filename, voxSpX, voxSpY, voxSpZ)
% WriteToVTK(matrix, filename, voxSpX, voxSpY, voxSpZ)
%
...
fwrite(fid, ['# vtk DataFile Version 2.0' nl 'Volume example' nl 'ASCII' nl ...
    ...
    num2str(N) ' ' num2str(M) ' ' num2str(O) nl 'SPACING ' num2str(voxSpX) ' ' num2str(voxSpY) ' ' num2str(voxSpZ) ' ' nl ...
