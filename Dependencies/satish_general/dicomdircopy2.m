function dicomdircopy2(drootname,filedata,destdir,folderfields,forcedpatientname)
% DICOMDIRCOPY
...
if ~exist('dicomdircopy','file')
    error('Add dependencies for dicomdircopy to path')
end
...
metadata.PatientName=forcedpatientname;
