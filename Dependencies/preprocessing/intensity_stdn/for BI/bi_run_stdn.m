%% Standardizing T2, DCE, ADC for EMPRAVISE journal paper expts, using int_stdn_landmarks.m
clear;clc;close all;
% addpath ~satish/Code/general/
addpath D:/my_code/general/

%% BIDMC T2
% load ~/T2+DCE+ADC/unstddata-21-Jun-2011.mat data %--> saved as ~/T2+DCE+ADC/TDA-t2std-20-Feb-2012.mat
load Z:/T2+DCE+ADC/t2stdn.mat std stdcancermasks stddatasetname
load Z:/T2+DCE+ADC/addtnlt2+dce-unstddata-06-Jan-2012.mat data %--> saved as ~/T2+DCE+ADC/addTD-t2std-20-Feb-2012.mat data
stdizeddata = data;
